...
export const about = [
  {
    deatils: [
      ...
      { text: "My Age", value: "30 Years 241 Days", icon: <AiOutlineCalculator /> },
      { text: "Email Address", value: "akp0791@gmail.com", icon: <GoMail /> },
      { text: "Phone Number", value: "7086956587", icon: <BsPhoneVibrate /> },
      { text: "Address", value: "Bengaluru, INDIA", icon: <MdShareLocation /> },
    ],
    bio: [
      {
